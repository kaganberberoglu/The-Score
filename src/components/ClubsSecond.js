                        ...
                        if (match === false) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    setTimeout(() => navigate("/bundesliga/league/table"), 500);
                                    setMatch(false);
                                    setRivalTotalScore(0);
                                    setYourTotalScore(0);
                                    setMoney(money - 1);
                            ...
                            {match === false ?
                                <Link to={`/bundesliga/league/${item.Squad.split(" ").join("-").toLowerCase()}`}>
                                    <button
                                        ...
                                        className="grid justify-items-center w-9 xl:w-12 hover:saturate-0 hover:font-semibold"
                                    >
                                        <img key={item.Rk} alt={item.Squad} src={require(`../assets/club-logos-second/${item.Rk}.png`)} />
                                    ...
                                    onClick={(e) => {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                setTimeout(() => navigate(`/bundesliga/league/${item.Squad.split(" ").join("-").toLowerCase()}`), 500);
                                                setMatch(false);
                                                setRivalTotalScore(0);
                                                setYourTotalScore(0);
                                                setMoney(money - 1);
