...
import { faPeopleGroup, faCircleXmark } from '@fortawesome/free-solid-svg-icons';

import { AppContext } from "../AppContext";
import useLocalStorage from "../useLocalStorage.js";

const TeamTactics = () => {
    const { theme, selectedPlayers, changeLang, dropPlayers, lineupAfterDrop, goalkeeperOne, setGoalkeeperOne, goalkeeperTwo, setGoalkeeperTwo, defenceOne, setDefenceOne, defenceTwo, setDefenceTwo, defenceThree, setDefenceThree, defenceFour, setDefenceFour, midOne, setMidOne, midTwo, setMidTwo, midThree, setMidThree, midFour, setMidFour, midFive, setMidFive, forwOne, setForwOne, forwTwo, setForwTwo, forwThree, setForwThree, jokerOne, setJokerOne, jokerTwo, setJokerTwo, jokerThree, setJokerThree, setRandomTeam, setNotRandomTeam, setTactic } = useContext(AppContext);
