...
const PlaySecond = () => {
    ...
    const rivalTeamPlayersEasy = dataSecond.players.filter(item => item.Coin > 5 && item.Coin < 30);
    const rivalTeamPlayersNormal = dataSecond.players.filter(item => item.Coin > 15 && item.Coin < 60);
    const rivalTeamPlayersHard = dataSecond.players.filter(item => item.Coin >= 25);
                ...
                <div className="grid justify-items-center">
                    ...
                    <div className="flex flex-row mb-3 mx-2">
                        <button
                            ...
                            onClick={() => {
                                navigate(`/bundesliga/team/${tactic}`);
                                setMatch(false);
