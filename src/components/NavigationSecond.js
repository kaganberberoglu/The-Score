                        ...
                        if (match === false) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    setTimeout(() => navigate("/bundesliga"), 500);
                                    setMatch(false);
                                    setRivalTotalScore(0);
                                    setYourTotalScore(0);
                                    setMoney(money - 1);
                        ...
                        if (match === false) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    setTimeout(() => navigate("/bundesliga/team/4-4-2"), 500);
                                    setMatch(false);
                                    setRivalTotalScore(0);
                                    setYourTotalScore(0);
                                    setMoney(money - 1);
                            ...
                            if (match === false) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        setTimeout(() => navigate("/bundesliga/team"), 500);
                                        setMatch(false);
                                        setRivalTotalScore(0);
                                        setYourTotalScore(0);
                                        setMoney(money - 1);
                        ...
                        if (match === false) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    setTimeout(() => navigate("/bundesliga/players"), 500);
                                    setMatch(false);
                                    setRivalTotalScore(0);
                                    setYourTotalScore(0);
                                    setMoney(money - 1);
