...
const Players = () => {
    const { theme, changeLang, selectPlayers, selectedPlayers, dropPlayers, arr, findPlayer, lineupAfterDrop } = useContext(AppContext);
                                    ...
                                    >
                                        ...
                                        <td className="pl-0.5 md:pl-1 lg:pl-1 xl:pl-1 py-0.5 font-semibold border-r border-black/25">
                                            <Link to="/league/table">
                                                <img className="rounded h-5 md:h-7 lg:h-8 xl:h-9" key={item.Club} alt={item.Club} src={require(`../assets/club-logos/${item.Club === "Manchester City" ? 1 : item.Club === "Arsenal" ? 2 : item.Club === "Manchester Utd" ? 3 : item.Club === "Newcastle Utd" ? 4 : item.Club === "Liverpool" ? 5 : item.Club === "Brighton" ? 6 : item.Club === "Aston Villa" ? 7 : item.Club === "Tottenham" ? 8 : item.Club === "Brentford" ? 9 : item.Club === "Fulham" ? 10 : item.Club === "Crystal Palace" ? 11 : item.Club === "Chelsea" ? 12 : item.Club === "Wolves" ? 13 : item.Club === "West Ham" ? 14 : item.Club === "Bournemouth" ? 15 : item.Club === "Nott'ham Forest" ? 16 : item.Club === "Everton" ? 17 : item.Club === "Leicester City" ? 18 : item.Club === "Leeds United" ? 19 : 20}.png`)} />
                                            </Link>
                                        </td>
                                        <td className="px-0.5 md:px-1 lg:px-1 xl:px-1 py-0.5 font-semibold border-r border-black/25">
                                            <p>
